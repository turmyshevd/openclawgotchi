...
def search_daily_logs(query: str, days: int = 30) -> list[str]:
    """
    Search recent daily logs for a text query.
    Returns list of matching lines with date prefix.
    """
    from datetime import timedelta
            ...
            try:
                ...
                for line in content.splitlines():
                    if query in line.lower():
                        ...
                        matches.append(f"[{date_str}] {clean_line}")
            except Exception:
                pass
